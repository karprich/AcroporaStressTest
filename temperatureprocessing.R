...
temp[temp$Date>as.POSIXct("2017-06-19 12:40:00") & temp$Date<as.POSIXct("2017-06-19 16:40:00"), "Tmpx19..6b.top.left"]<-NA
# ADD Other cleaning times
temp[temp$Date>as.POSIXct("2017-05-31 11:30:00") & temp$Date<as.POSIXct("2017-06-19 16:40:00"), ]<-NA
...
par(mfrow = c(1, 1))
plot(temp$Projected ~ temp$Days, type = "l", ylim=c(25, 35), lwd = 2, main = "TR", xlab = "Date", ylab = "Temperature (oC)")
lines(temp$Thres~temp$Days, col = 'orange', lty = 2)
lines(smooth_tl ~ temp$Days, col = 'blue')
