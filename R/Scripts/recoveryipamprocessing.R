...
allRec <- rbind(combine_ipam1, combine_ipam2, combine_ipam3, cor_combine_ipam4, cor_combine_ipam5, combine_ipam6, combine_ipam7, combine_ipam8, combine_ipam9, combine_ipam10, combine_ipam11, combine_ipam12, combine_ipam13, combine_ipam14, combine_ipam15, combine_ipam16)
...
library(lattice)
png(filename = "Output/Figures/1strecovery.png", width=7, height = 7, units = "in", res = 300)
